var CardFilter = Class.extend({
    ...
    buildUi:function (elem, pageElem) {
        ...
        this.setSelect = $("<select id='setSelect' class='filterInput'>"
            ...
            + "<option value='223'>Set 23</option>"
            + "<option value='224'>Set 24</option>"
            + "<option value='225'>Set 25</option>"
            + "<option value='226'>Set 26</option>"
            + "<option value='227'>Set 27</option>"
            + "<option value='301'>Virtual Premium Set</option>"
            + "<option value='302'>Dark Jedi Brotherhood Core</option>"
            + "<option value='303'>Shadow Academy</option>"
            + "<option value='304'>The Great Hutt Expansion</option>"
			+ "<option value='305'>A Better Tomorrow</option>"
        ...
        this.iconSelect = $("<select id='iconSelect' class='filterInput'>"
            ...
            + "<option value='VIRTUAL_SET_19'>Set 19</option>"
            + "<option value='VIRTUAL_SET_20'>Set 20</option>"
            + "<option value='VIRTUAL_SET_21'>Set 21</option>"
            + "<option value='VIRTUAL_SET_22'>Set 22</option>"
            + "<option value='VIRTUAL_SET_23'>Set 23</option>"
            + "<option value='VIRTUAL_SET_24'>Set 24</option>"
            + "<option value='VIRTUAL_SET_25'>Set 25</option>"
            + "<option value='VIRTUAL_SET_26'>Set 26</option>"
            + "<option value='VIRTUAL_SET_27'>Set 27</option>"
            ...
            + "<option value='UNDERGROUND'>Underground Site</option>"
            + "<option value='UNDERWATER'>Underwater Site</option>"
        ...
        this.personaSelect = $("<select id='personaSelect' class='filterInput'>"
            ...
            + "<option value='ANAKINS_LIGHTSABER'>Anakin's Lightsaber</option>"
			...
			+ "<option value='KAI'>Kai</otpion>"
			+ "<option value='KAMJIN'>Kamjin</option>"
            + "<option value='KANAN'>Kanan</option>"
			+ "<option value='KOMILIA'>Komilia</option>"
            + "<option value='KRENNIC'>Krennic</option>"
            + "<option value='KYLO'>Kylo</option>"
            + "<option value='KYLOS_LIGHTSABER'>Kylo's Lightsaber</option>"
            ...
            + "<option value='TANTIVE_IV'>Tantive IV</option>"
