...
public enum ModifierType {
    ...
    MANEUVER, UNMODIFIABLE_MANEUVER, MANEUVER_INCREASE_FROM_PILOT_LIMIT,
	...
	MAY_DEPLOY_TO_SHADOW_ACADEMY_TARGET,
    MAY_DEPLOY_TO_ARX_TARGET,
    ...
    ABILITY_REQUIRED_FOR_BATTLE_DESTINY_MODIFIER, ABILITY_HARD_REQUIREMENT_FOR_BATTLE_DESTINY, ABILITY_MORE_THAN_HARD_REQUIREMENT_FOR_BATTLE_DESTINY,
    ...
    MAY_NOT_CANCEL_BATTLE, TOTAL_POWER_DURING_BATTLE, CAPTIVE_MAY_PARTICIPATE_IN_BATTLE,
    ...
    BLOW_AWAY_ECHO_OF_VAUZEM_ATTEMPT_TOTAL,
    ...
    MAY_NOT_DEPLOY_MOVE_PLAGUEIS_PROBE_DROID,
    ...
    MAY_MOVE_MEDIUM_REPEATING_BLASTER_CANNON_ALONE_FOR_FREE,
    MAY_NOT_BE_REVIVED,
    MAY_NOT_BE_TURNED_ON,
    MAY_NOT_BREAK_OWN_COVER_DURING_DEPLOY_PHASE,
    MAY_NOT_SEARCH_CARD_PILE,
    LOSE_FORCE_IF_LOST_TO_ASTEROID_DESTINY,
    ...
    CONFLICT_CARD,
    CREDIT_CARD,
	HIVE_OF_SCUM_AND_VILLAINY_MAY_DEPLOY_HERE,
}
