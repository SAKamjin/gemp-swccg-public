...
public enum Persona implements Filterable {
    ...
    BAZES_CANNON("Baze's Cannon"),
    BOBA_FETTS_BLASTER_RIFLE("Boba Fett's Blaster Rifle"),
    BOSSKS_MORTAR_GUN("Bossk's Mortar Gun"),
    CARAS_HEAVY_BLASTER_RIFLE("Cara's Heavy Blaster Rifle"),
    CHEWBACCAS_BOWCASTER("Chewbacca's Bowcaster"),
    DENGARS_BLASTER_CARBINE("Dengar's Blaster Carbine"),
    DOOKUS_LIGHTSABER("Dooku's Lightsaber"),
    EZRAS_BLASTER_LIGHTSABER("Ezra's Blaster Lightsaber"),
    GALENS_LIGHTSABER("Galen's Lightsaber"),
    HANS_HEAVY_BLASTER_PISTOL("Han's Heavy Blaster Pistol"),
    KYLOS_LIGHTSABER("Kylo's Lightsaber"),
    LADY_VADERS_BLASTER_RIFLE("Lady Vader's Blaster Rifle"),
    LANDOS_BLASTER_RIFLE("Lando's Blaster Rifle"),
    ...
    OBIWANS_LIGHTSABER("Obi-Wan's Lightsaber"),
    ORTUGGS_AX("Ortugg's Ax"),
