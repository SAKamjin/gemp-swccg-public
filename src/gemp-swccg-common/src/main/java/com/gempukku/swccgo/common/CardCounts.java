...
public interface CardCounts {
    ...
    int[] VIRTUAL_SETS_CARD_COUNTS = {146, 42, 15, 36, 58, 23, 14, 30, 59, 56, 47, 61, 6, 59, 22, 27, 49, 52, 32, 48, 10, 75, 30, 49, 23, 59, 28, 1};

    int[] VIRTUAL_PREMIUM_SETS_CARD_COUNTS = {8, 100, 100, 200, 300};
