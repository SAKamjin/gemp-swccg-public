...
public class MerchantService {
    ...
    public MerchantService(SwccgCardBlueprintLibrary library, CollectionsManager collectionsManager, MerchantDAO merchantDAO) {
        ...
        addFixedItem(ProductName.GREAT_HUTT_EXPANSION_BOOSTER_PACK, ProductPrice.GREAT_HUTT_EXPANSION_BOOSTER_PACK);
        addFixedItem(ProductName.A_BETTER_TOMORROW_BOOSTER_PACK, ProductPrice.A_BETTER_TOMORROW_BOOSTER_PACK);
        ...
        addFixedItem(ProductName.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_4, ProductPrice.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_5, ProductPrice.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_6, ProductPrice.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_7, ProductPrice.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_8, ProductPrice.VIRTUAL_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_1, ProductPrice.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_2, ProductPrice.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_3, ProductPrice.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK);
        addFixedItem(ProductName.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK_SERIES_4, ProductPrice.DBCCG_ALTERNATE_IMAGE_BOOSTER_PACK);
    }
