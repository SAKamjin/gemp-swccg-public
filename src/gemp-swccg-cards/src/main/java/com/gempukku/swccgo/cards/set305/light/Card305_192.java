 ...
 * Title: Arnid Vus
 */
public class Card305_192 extends AbstractAlien {
    public Card305_192() {
        super(Side.LIGHT, 3, 3, 2, 2, 4, "Arnid Vus", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.U);
        setLore("Experimented on by the Collective, Arnid Vus has become a genius in biotechnology. ");
        ...
        addPersona(Persona.ARNID);
        setMatchingStarshipFilter(Filters.Argentum_Baet);
    }

    @Override
    protected List<OptionalGameTextTriggerAction> getGameTextOptionalAfterTriggers(final String playerId, final SwccgGame game, EffectResult effectResult, final PhysicalCard self, int gameTextSourceCardId) {
        GameTextActionId gameTextActionId = GameTextActionId.ARNID_VUS__SEARCH_LOST_PILE;
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        GameTextActionId gameTextActionId = GameTextActionId.ARNID_VUS__CANCEL_DROID_GAME_TEXT;
