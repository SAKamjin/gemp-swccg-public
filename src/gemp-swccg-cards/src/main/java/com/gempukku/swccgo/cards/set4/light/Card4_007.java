 ...
 * Title: Vine Snake
 */
public class Card4_007 extends AbstractCreature {
    public Card4_007() {
        super(Side.LIGHT, 3, 2, 0, 3, 0, "Vine Snake", Uniqueness.UNRESTRICTED, ExpansionSet.DAGOBAH, Rarity.C);
        setLore("Constricts hapless victims. Prey usually struggles at first, then weakens as strength diminishes. Difficult to spot. Common hazard on less-developed worlds.");
