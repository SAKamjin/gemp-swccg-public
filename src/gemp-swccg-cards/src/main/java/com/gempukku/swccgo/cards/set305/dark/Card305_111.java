 ...
 * Title: Caelum Reth
 */
public class Card305_111 extends AbstractAlien {
    public Card305_111() {
        super(Side.DARK, 2, 2, 1, 2, 3, "Caelum Reth", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.U);
        setLore("Sephi pilot assigned personally to Duke Airron Uleich. Served in the merchant corp before joining the Vauzem Dominion.");
