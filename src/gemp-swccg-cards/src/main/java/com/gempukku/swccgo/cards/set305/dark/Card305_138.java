 ...
 * Type: Weapon
 * Subtype: Character
 * Title: Komilia Lap'lamiz's Lightsaber
 */
public class Card305_138 extends AbstractCharacterWeapon {
    public Card305_138() {
        super(Side.DARK, 1, "Komilia Lap'lamiz's Lightsaber", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("During Komilia's exile, when her Grandfather's lightsaber was taken from her she created her own lightsaber. Unlike her brother Rohan, she eagerly bled the first Kyber crystal she obtained. ");
        setGameText("Deploy on Komilia. Adds 1 to defense value and training destiny. May add 1 to Force drain where present. May target a character, creature, speeder bike, or swoop for free. Draw 2 destiny. Target hit, and its forfeit = 0 if total destiny > defense value.");
        addPersona(Persona.KOMILIAS_LIGHTSABER);
        addIcons(Icon.ABT);
        addKeywords(Keyword.LIGHTSABER);
        setMatchingCharacterFilter(Filters.Komilia);
    }

    @Override
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.Komilia);
    }
