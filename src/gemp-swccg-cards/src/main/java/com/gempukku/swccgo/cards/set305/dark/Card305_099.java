 ...
 * Type: Character
 * Subtype: Alien
 * Title: Lady Morvayne Korr
 */
public class Card305_099 extends AbstractAlien {
    public Card305_099() {
        super(Side.DARK, 2, 2, 2, 3, 4, "Lady Morvayne Korr", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("Lady Morvayne has invested heavily in the restarted CIS droid factories. As such, she's been given the title of Lady. Despite the title she has few friends amongst the Vauzem Dominion.");
