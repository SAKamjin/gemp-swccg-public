 ...
 * Title: Jan Korsik
 */
public class Card305_155 extends AbstractAlien {
    public Card305_155() {
        super(Side.DARK, 2, 3, 3, 4, 3, "Jan Korsik", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("Originally a hired gangster of the Hutt cartels. Jan was eventually found by Bril Teg Erinos who helped him flee to the Brotherhood where he was trained as a Force sensitive acolyte.");
        ...
        addKeywords(Keyword.MALE, Keyword.GANGSTER );
