 ...
 * Type: Starship
 * Subtype: Capital
 * Title: Vauzem Dominion Battleship
 */
public class Card305_121 extends AbstractCapitalStarship {
    public Card305_121() {
        super(Side.DARK, 2, 7, 6, 6, null, 3, 7, "Vauzem Dominion Battleship", Uniqueness.UNRESTRICTED, ExpansionSet.ABT, Rarity.U);
        setLore("Once mighty battleships for the Trade Federation the Vauzem Dominion has restored them to their former glory.");
