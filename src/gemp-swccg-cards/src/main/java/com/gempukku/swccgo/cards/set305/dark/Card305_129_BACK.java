 ...
 */
public class Card305_129_BACK extends AbstractObjective {
    public Card305_129_BACK() {
        super(Side.DARK, 7, Title.We_Control_The_Planet, ExpansionSet.ABT, Rarity.U);
        setGameText("While this side up, you lose no more than 2 Force to any Force drain. Your battle droids deploy -1. If you have two [Presence] droids with different card titles (or a [Presence] droid and a Sephi) in battle at a site, draw two battle destiny if unable to otherwise. Your droid starfighters are immune to attrition < 3. If opponent just drew an Interrupt for battle destiny, once per battle you may place that card out of play. Flip this card if opponent controls Quermia system or Senate Council Chambers.");
        addIcons(Icon.ABT);
    }
        ...
        modifiers.add(new DrawsBattleDestinyIfUnableToOtherwiseModifier(self, Filters.your(self), new AndCondition(new DuringBattleAtCondition(Filters.site),
                new OrCondition(new DifferentCardTitlesParticipatingInBattleCondition(Filters.and(Filters.your(self), Icon.PRESENCE, Filters.droid)),
                        new AndCondition(new DuringBattleWithParticipantCondition(Filters.and(Filters.your(self), Icon.PRESENCE, Filters.droid)),
                                         new DuringBattleWithParticipantCondition(Filters.and(Filters.your(self), Filters.Sephi))))), 2));
    ...
    protected List<RequiredGameTextTriggerAction> getGameTextRequiredAfterTriggers(SwccgGame game, EffectResult effectResult, PhysicalCard self, int gameTextSourceCardId) {
        ...
        if (TriggerConditions.isTableChanged(game, effectResult)
                ...
                && GameConditions.controls(game, opponent, SpotOverride.INCLUDE_EXCLUDED_FROM_BATTLE, Filters.or(Filters.Quermia_system, Filters.Senate_Council_Chambers))) {
