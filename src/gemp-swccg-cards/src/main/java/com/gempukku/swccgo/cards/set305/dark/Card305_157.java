 ...
 * Title: Bionic Hand
 */
public class Card305_157 extends AbstractCharacterDevice {
    public Card305_157() {
        super(Side.DARK, 7, "Bionic Hand", Uniqueness.UNRESTRICTED, ExpansionSet.ABT, Rarity.U);
        setLore("Often made with substandard parts the Empire assumes that if you lose a limb the likelihood you'll lose it again goes up. Therefore, why invest in something likely to be lost again.");
