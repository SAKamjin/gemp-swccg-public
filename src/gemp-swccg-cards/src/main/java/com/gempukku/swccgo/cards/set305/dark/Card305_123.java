 ...
 * Title: They're Falling Apart
 */
public class Card305_123 extends AbstractUsedOrLostInterrupt {
    public Card305_123() {
        super(Side.DARK, 4, "They're Falling Apart", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.C);
        setLore("The repurposed A-Wings used by Sapphire Squadron are held together with patchy repairs. They're prone to failure at the worse times.");
        setGameText("USED: For remainder of turn, subtract 2 from any attempt to 'blow away' Echo of Vauzem. LOST: During any deploy phase, use 3 Force to target any starship at same system as your battleship. Target is hyperspeed = 0 until end of turn.");
        addIcons(Icon.ABT);
    }
    ...
    protected List<PlayInterruptAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self) {
        ...
        if (GameConditions.canSpot(game, self, Filters.ECHO_OF_VAUZEM)) {
            ...
            action.setText("Subtract 2 from attempts to 'blow away' Echo of Vauzem");
            // Allow response(s)
                        ...
                        protected void performActionResults(Action targetingAction) {
                            ...
                            action.appendEffect(
                                    new AddUntilEndOfTurnModifierEffect(action,
                                            ...
                                            "Subtracts 2 from attempts to 'blow away' Echo of Vauzem"));
                        }
                    }
            );
            actions.add(action);
