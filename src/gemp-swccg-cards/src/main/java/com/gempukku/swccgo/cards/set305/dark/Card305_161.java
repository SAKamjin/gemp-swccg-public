 ...
 */
public class Card305_161 extends AbstractNormalEffect {
    public Card305_161() {
        super(Side.DARK, 4, PlayCardZoneOption.ATTACHED, Title.Force_Amplification, Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("Force users can perform amazing physical feats by channeling the Force through their bodies. However, these abilities come at a cost if the Force user isn't properly trained.");
