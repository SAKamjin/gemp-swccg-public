 ...
 * Type: Weapon
 * Subtype: Character
 * Title: Rohan Lap'lamiz's Lightsaber
 */
public class Card305_137 extends AbstractCharacterWeapon {
    public Card305_137() {
        super(Side.DARK, 1, "Rohan Lap'lamiz's Lightsaber", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("Created by Rohan when he began his Sith training with his father. Unlike other acolytes, Rohan used a synthetic crystal and did not bleed his original Kyber crystal.");
        setGameText("Deploy on Rohan. Adds 1 to defense value and training destiny. May add 1 to Force drain where present. May target a character, creature, speeder bike, or swoop for free. Draw 2 destiny. Target hit, and its forfeit = 0 if total destiny > defense value.");
        addPersona(Persona.ROHANS_LIGHTSABER);
        addIcons(Icon.ABT);
        addKeywords(Keyword.LIGHTSABER);
        setMatchingCharacterFilter(Filters.Rohan);
    }

    @Override
    protected Filter getGameTextValidDeployTargetFilter(SwccgGame game, PhysicalCard self, PlayCardOptionId playCardOptionId, boolean asReact) {
        return Filters.and(Filters.your(self), Filters.Rohan);
    }

    @Override
    protected Filter getGameTextValidToUseWeaponFilter(final SwccgGame game, final PhysicalCard self) {
        return Filters.Rohan;
    }
