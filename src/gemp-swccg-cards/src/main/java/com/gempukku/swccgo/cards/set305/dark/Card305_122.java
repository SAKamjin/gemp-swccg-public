 ...
 * Type: Starship
 * Subtype: Capital
 * Title: Vauzem Dominion Landing Craft
 */
public class Card305_122 extends AbstractCapitalStarship {
    public Card305_122() {
        super(Side.DARK, 2, 1, 2, 4, null, null, 3, "Vauzem Dominion Landing Craft", Uniqueness.UNRESTRICTED, ExpansionSet.ABT, Rarity.C);
        setLore("C-9979 landing craft designed to transport and unload Multi Troop Transports and its battle droid cargo for the Vauzem Dominion. Still in mint condition.");
        ...
        addIcons(Icon.ABT, Icon.VAUZEM, Icon.PILOT, Icon.NAV_COMPUTER, Icon.PRESENCE);
    ...
    protected List<TopLevelGameTextAction> getGameTextTopLevelActions(final String playerId, final SwccgGame game, final PhysicalCard self, int gameTextSourceCardId) {
        GameTextActionId gameTextActionId = GameTextActionId.VAUZEM_DOMINION_LANDING_CRAFT__UPLOAD_MTT;
