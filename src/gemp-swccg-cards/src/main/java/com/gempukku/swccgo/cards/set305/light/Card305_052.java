 ...
 * Type: Weapon
 * Subtype: Character
 * Title: DG-29 Heavy Blaster Pistol
 */
public class Card305_052 extends AbstractCharacterWeapon {
    public Card305_052() {
        super(Side.LIGHT, 2, "DG-29 Heavy Blaster Pistol", Uniqueness.UNRESTRICTED, ExpansionSet.ABT, Rarity.C);
        setLore("Manufactured by BlasTech and sporting an image-intensifying macroscope for long-range shots. ");
