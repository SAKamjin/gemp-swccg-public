 ...
 * Type: Interrupt
 * Subtype: Lost
 * Title: Sabacc Cheater
 */
public class Card305_166 extends AbstractLostInterrupt {
    public Card305_166() {
        super(Side.DARK, 3, Title.Sabacc_Cheater, Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("There's nothing worse than someone who's willing to cheat at Sabacc.");
