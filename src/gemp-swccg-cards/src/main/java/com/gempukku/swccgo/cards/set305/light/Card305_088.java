 ...
 * Title: You Go First...
 */
public class Card305_088 extends AbstractUsedOrLostInterrupt {
    public Card305_088() {
        super(Side.LIGHT, 5, "You Go First...", Uniqueness.UNIQUE, ExpansionSet.ABT, Rarity.R);
        setLore("'If you think fighting Jedi is a good idea.'");
        setGameText("USED: Target your [COU] Jedi defending a battle. Target is immune to attrition for rest of turn (unless Dark Jedi present). LOST: In a battle you lost, place a [COU] member with Ability > 4 you just forfeited in Used Pile to cancel all battle damage and attrition against you.");
        addIcons(Icon.ABT);
    }

    @Override
    protected List<PlayInterruptAction> getGameTextTopLevelActions(final String playerId, SwccgGame game, final PhysicalCard self) {
        Filter filter = Filters.and(Filters.your(self), Icon.COU, Filters.Jedi, Filters.defendingBattle);
    ...
    protected List<PlayInterruptAction> getGameTextOptionalAfterActions(final String playerId, SwccgGame game, EffectResult effectResult, final PhysicalCard self) {
        // Check condition(s)
        if (TriggerConditions.justForfeited(game, effectResult, playerId, Filters.and(Filters.COU_character, Filters.abilityMoreThan(4)))
